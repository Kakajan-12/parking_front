            ...
            <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                    ...
                    <tr className="border-b">
                        ...
                        <td className="px-4 py-2">{data.carNumber}</td>
                    </tr>
                    <tr className="border-b">
                        <th
                            scope="row"
                    ...
                    <tr className="border-b">
                        ...
                        <td className="px-4 py-2">
                            <Badge variant={data.isStaff ? "secondary" : "destructive"}>
                                {data.isStaff ? (
                                    <Badge variant="secondary">{t("cars-page.staff")}</Badge>
                                ) : (
                                    <Badge variant="destructive">{t("cars-page.non-staff")}</Badge>
                                )}
                            </Badge>
                        </td>
                    </tr>
