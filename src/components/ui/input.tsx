...
type PolymorphicInputProps<T extends ElementType = "input"> = BaseInputProps &
    Omit<React.ComponentPropsWithoutRef<T>, keyof BaseInputProps> & {
        as?: T;
    };

const InputInner = <T extends ElementType = "input">(
    {
        as,
        className = "",
        inputClassName = "",
...
// Assign display name before casting
InputInner.displayName = "Input";

// Cast to the final type with forwardRef
const Input = forwardRef(InputInner) as <T extends ElementType = "input">(
    props: PolymorphicInputProps<T> & { ref?: React.ForwardedRef<HTMLInputElement> },
) => React.ReactElement;
